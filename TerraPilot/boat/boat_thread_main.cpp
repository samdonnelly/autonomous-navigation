...
void Boat::MainInitState(Boat& data, Event event)
{
    ...
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::INIT_STATE), data.main_state_flags.flags);

        // Load vehicle data from memory 
        data.memory.MemoryLoad(data);
    ...
    switch (data.main_event)
    {
        case MainEvents::INIT: 
            data.MainStateSelect(static_cast<uint8_t>(MainStates::HOLD_STATE));
            break;
...
void Boat::MainHoldState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::HOLD_STATE), data.main_state_flags.flags);
...
void Boat::MainManualState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::MANUAL_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainAcroState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::ACRO_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainSteeringState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::STEERING_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainLoiterState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::LOITER_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainFollowState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::FOLLOW_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainSimpleState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::SIMPLE_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainDockState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::DOCK_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainCircleState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::CIRCLE_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainAutoState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::AUTO_STATE), data.main_state_flags.flags);
...
void Boat::MainRTLState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::RTL_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainSmartRTLState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::SMART_RTL_STATE), data.main_state_flags.flags);
    }
...
void Boat::MainGuidedState(Boat& data, Event event)
{
    if (data.main_system_flags.state_entry)
    {
        data.MainStateEnter(static_cast<uint8_t>(MainStates::GUIDED_STATE), data.main_state_flags.flags);
    }
